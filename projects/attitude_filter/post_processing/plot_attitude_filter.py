...
axs[0].plot(sim_time_sec[1:], q_j2000_to_body_est[1:, 0], linewidth=3.0, linestyle='-', label="Est")
axs[0].plot(sim_time_sec[1:], q_j2000_to_body_true[1:, 0], linewidth=3.0, linestyle='--', label="True")

axs[1].plot(sim_time_sec[1:], q_j2000_to_body_est[1:, 1], linewidth=3.0, linestyle='-', label="Est")
axs[1].plot(sim_time_sec[1:], q_j2000_to_body_true[1:, 1], linewidth=3.0, linestyle='--', label="True")

axs[2].plot(sim_time_sec[1:], q_j2000_to_body_est[1:, 2], linewidth=3.0, linestyle='-', label="Est")
axs[2].plot(sim_time_sec[1:], q_j2000_to_body_true[1:, 2], linewidth=3.0, linestyle='--', label="True")

axs[3].plot(sim_time_sec[1:], q_j2000_to_body_est[1:, 3], linewidth=3.0, linestyle='-', label="Est")
...
axs[0].plot(sim_time_sec[1:], est_gyro_biases_deg[1:, 0], linewidth=3.0, linestyle='-', label="Est")
axs[0].plot(sim_time_sec[1:], true_gyro_biases_deg[1:, 0], linewidth=3.0, linestyle='--', label="True")

axs[1].plot(sim_time_sec[1:], est_gyro_biases_deg[1:, 1], linewidth=3.0, linestyle='-', label="Est")
axs[1].plot(sim_time_sec[1:], true_gyro_biases_deg[1:, 1], linewidth=3.0, linestyle='--', label="True")

axs[2].plot(sim_time_sec[1:], est_gyro_biases_deg[1:, 2], linewidth=3.0, linestyle='-', label="Est")
...
# True and Estimated Biases
axs[0].plot(sim_time_sec[1:], est_gyro_misalign_deg[1:, 0], linewidth=3.0, linestyle='-', label="Est")
axs[0].plot(sim_time_sec[1:], true_gyro_misalign_deg[1:, 0], linewidth=3.0, linestyle='--', label="True")

axs[1].plot(sim_time_sec[1:], est_gyro_misalign_deg[1:, 1], linewidth=3.0, linestyle='-', label="Est")
axs[1].plot(sim_time_sec[1:], true_gyro_misalign_deg[1:, 1], linewidth=3.0, linestyle='--', label="True")

axs[2].plot(sim_time_sec[1:], est_gyro_misalign_deg[1:, 2], linewidth=3.0, linestyle='-', label="Est")
...
# True and Estimated Biases
axs[0].plot(sim_time_sec[1:], est_gyro_sf_ppm[1:, 0], linewidth=3.0, linestyle='-', label="Est")
axs[0].plot(sim_time_sec[1:], true_gyro_sf_ppm[1:, 0], linewidth=3.0, linestyle='--', label="True")

axs[1].plot(sim_time_sec[1:], est_gyro_sf_ppm[1:, 1], linewidth=3.0, linestyle='-', label="Est")
axs[1].plot(sim_time_sec[1:], true_gyro_sf_ppm[1:, 1], linewidth=3.0, linestyle='--', label="True")

axs[2].plot(sim_time_sec[1:], est_gyro_sf_ppm[1:, 2], linewidth=3.0, linestyle='-', label="Est")
