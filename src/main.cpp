...
int main() { 
    ...
    Matrix2D<double, 3,3> A1_inv_expected = { 1.0/3.0,  1.0,     -5.0/3.0,
                                          -1.0/3.0, 0.0,      2.0/3.0,
                                           1.0,     -2.0,     1.0};
    A1_inv_expected.print();


    Matrix2D<double, 3,3> A2 = {1, 2, 3,
                            0, 1, 4,
                            5, 6, 0};
    A2.print();
    ...
    Matrix2D<double, 3,3> A2_inv_expected = {-24, 18,  5,
                                            20, -15, -4,
                                            -5,   4,  1};
    A2_inv_expected.print();

    Matrix2D<double, 3,3> A3 = {2, -1, 0,
                           -1,  2, -1,
                            0, -1,  2};
    A3.print();
    ...
    Matrix2D<double, 3,3> A3_inv_expected = {0.75, 0.5, 0.25,
                                            0.5,  1.0, 0.5,
                                            0.25, 0.5, 0.75};
    A3_inv_expected.print();

    Matrix2D<double, 3,3> A4 = {3, 0, 2,
                            2, 0, -2,
                            0, 1, 1};
    A4.print();
    ...
    Matrix2D<double, 3,3> A4_inv_expected = { 0.2,  0.2,  0,
                                            -0.2,  0.3,  1,
                                            0.2, -0.3,  0};
