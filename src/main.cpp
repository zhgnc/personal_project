...
int main() {
  const std::string &sim_config_path =
      "examples/attitude_filter/config_files/simulation_config.yaml";
  const std::string &priority_config_path =
      "examples/attitude_filter/config_files/app_priorities.yaml";
  const std::string &gyro_config_path =
      "examples/attitude_filter/config_files/gyro_config.yaml";
  ...
  std::shared_ptr<GyroSimInterface> gyro_interface =
      std::make_shared<GyroSimInterface>();
  std::shared_ptr<SimApp> gyro_app = std::make_shared<SimApp>(
      gyro_interface, gyro_rate, gyro_priority, gyro_config_path);
